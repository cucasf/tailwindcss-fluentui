...
let xRe = /^[x]+/;
const fluetuiThemePlugin = plugin_1.default.withOptions(function (options) {
    return function (api) {
        var _a;
        log_1.default.info('tailwindcss-fluentui:plugin:theme:handler');
    ...
    log_1.default.info('tailwindcss-fluentui:plugin:theme:config');
...
module.exports = fluetuiThemePlugin;
