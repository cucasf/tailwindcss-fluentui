...
import type { AlphaColors, BrandVariants, ColorVariants, Greys, StatusColorVariants } from './types';
...
const grey10Alpha: Record<AlphaColors, string> = {
...
const grey12Alpha: Record<AlphaColors, string> = {
...
const grey14Alpha: Record<AlphaColors, string> = {
...
const statusColors: StatusColorVariants = {
    warning: orange,
    danger: cranberry,
    success: green,    
}
...
const colors: RecursiveKeyValuePair  = {
    ...
    black: black,
    hc:{
      hyperlink: hcHyperlink,
      highlight: hcHighlight,
      disabled: hcDisabled,
      canvas: hcCanvas,
      canvasText: hcCanvasText,
      highlightText: hcHighlightText,
      buttonText: hcButtonText,
      buttonFace: hcButtonFace
    },
    darkRed: darkRed,
    burgundy: burgundy,
    cranberry: cranberry,
    ...
    anchor: anchor,
    charcoal: charcoal,
    success: statusColors.success ?? green,
    warning: statusColors.warning ?? orange,
    danger: statusColors.danger ?? cranberry,
}
