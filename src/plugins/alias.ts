import { KeyValuePair, PluginAPI, RecursiveKeyValuePair } from 'tailwindcss/types/config'
 ...
 */
function GenerateAliases(colors: RecursiveKeyValuePair,  mapping: AliasMapping, colorNames: string[], themes: string[])
{
...
const aliasPlugin = plugin.withOptions<aliasPluginOptions>(
    ...
    function(options: aliasPluginOptions = defaultAliasPluginOptions) {
        ...
        let aliases = {
            ...GenerateAliases(colors, colorNeutralMapping, [''],  options.themes || ['light']),
            ...GenerateAliases(colors, statusSharedColorsMapping, options.alias?.statusSharedColors || [],  options.themes || ['light']),
            ...GenerateAliases(colors, personaSharedColorsMapping, options.alias?.personaSharedColors || [],  options.themes || ['light']),
            ...GenerateAliases(colors, statusColorsMapping, options.alias?.mappedStatusColors || [],  options.themes || ['light']),
        }
