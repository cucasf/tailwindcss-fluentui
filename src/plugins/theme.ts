...
const fluetuiThemePlugin = plugin.withOptions<fluetuiPluginOptions>(
    function(options: fluetuiPluginOptions) { return function(api: PluginAPI) {
        log.info('tailwindcss-fluentui:plugin:theme:handler')
    ...
    function(options: fluetuiPluginOptions) { 
        log.info('tailwindcss-fluentui:plugin:theme:config')
